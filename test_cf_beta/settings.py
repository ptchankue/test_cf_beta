"""
Django settings for test_cf_beta project.
...
SECRET_KEY = 'o&#f6en*36t$-%2z*9)!7gc!j0^kx5t1yc+&+v-)grnp!g+i&o'
...
ROOT_URLCONF = 'test_cf_beta.urls'

WSGI_APPLICATION = 'test_cf_beta.wsgi.application'
